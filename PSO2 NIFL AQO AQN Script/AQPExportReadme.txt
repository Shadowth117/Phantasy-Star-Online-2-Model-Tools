...
-DXT1 _n texture in the bump slot

PSO2 materials support a maximum of 4 texture maps normally and the order is important.
...
-Memory usage is currently very unoptimized because Maxscript has poor memory management with arrays. This will be fixed eventually, but for now, I apologize!
-There is no progress bar, but as long as there is no error, it is continuing. Expect it to take a few minutes potentially. A progress bar may be implemented eventually.
